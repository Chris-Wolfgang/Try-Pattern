...
' Try is reserved in VB, so we need to alias the import
Imports TryRunner = Wolfgang.TryPattern.Try
...
Namespace CSharp.DotNet462.Example
	Friend Module Module1
		...
		Public Async Function MainAsync() As Task
			...
			Dim fileReadResult = Await TryRunner.RunAsync(Function() File.ReadAllTextAsync(".\sample.txt"))
			...
			Dim wordCountResult = TryRunner.Run(Function() GetWordCount(fileReadResult.Value))
			...
			wordCountResult = TryRunner.Run(Function() GetWordCount(Nothing))
